public class CannonDatatable : ModelDatatable
{
    ...
    private static DataSet[] GetProperties()
    {
        return new DataSet[] {
            ...
            //Spawn projectile
            new DataSet(TriggerPreset.Preset.Request, new string[]{ "</>", "1", "1"}),
            new DataSet(TriggerPreset.Preset.Spawn, new string[]{ "</>", "<action,2/>",  "0"}),
            new DataSet(TriggerPreset.Preset.Chain, new string[]{ "</>", "<prop,2/>", "<prop,3/>", "0"}), //Usage index 4
            ...
            new DataSet(TriggerPreset.Preset.Chain, new string[]{ "</>", "<prop,4/>", "<prop,6/>", "0"}), //Usage index 7
            //Move cannon
            new DataSet(EffectPreset.Preset.Modifier, new string[]{ "2", "<action,0/>", "1"  }),
            new DataSet(TriggerPreset.Preset.Target, new string[]{ "</>", "<init,0/>", "<prop,8/>", "0"}), //Usage index 9
        };
    }
