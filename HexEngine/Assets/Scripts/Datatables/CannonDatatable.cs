public class CannonDatatable : Datatable
{
    ...
    private static DataSet[] GetProperties()
    {
        return new DataSet[] {
            ...
            new DataSet("model,storage", new string[]{"3", "10", "<init,0.CommonPropertySet.~Coordinate/>","", "2" }), //Usage index 1
            ...
            new DataSet("trigger,collision", new string[]{ "<action,1/>", "<action,1.CommonPropertySet.Coordinate/>", "10", "0"}),
