public class DummyDatatable : Datatable
{
    ...
    private static DataSet[] GetProperties()
    {
        return new DataSet[] {
            // Dummy body
            new DataSet(ModelPreset.Preset.Model, new string[]{"10", "10", "<action,0/>", "10", "Dummy", "0", "0", "0", "<prop,1/>", "3" }),
            ...
            new DataSet(PropertyPreset.Preset.Mount, new string[]{null, "head", "<action,1/>", "<prop,5/>" }),

            // Dummy head
            new DataSet(ModelPreset.Preset.Model, new string[]{"5", "5", "<action,0/>", "5", "", "0", "0", "0", "<prop,6/>", "2" }),
            new DataSet(PropertyPreset.Preset.CombatProperty, new string[]{"<prop,7/>" }),
            new DataSet(PropertyPreset.Preset.Armor, new string[]{"1", "1" })
        };
    }
}
