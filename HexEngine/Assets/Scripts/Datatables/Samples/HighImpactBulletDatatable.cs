public class HighImpactBulletDatatable : Datatable
{
    ...
    {
        return new DataSet[] {
            new DataSet(ModelPreset.Preset.Model, new string[]{"2", "2", "<action,0.CommonPropertySet.~Coordinate/>", "2", "", "0", "0", "0", "<prop,1/>", "2" }),
            new DataSet(PropertyPreset.Preset.CombatProperty, new string[]{"<prop,2/>", "<prop,3/>" }),
            new DataSet(PropertyPreset.Preset.Damage, new string[]{"0", "-5.0", "false" }),
